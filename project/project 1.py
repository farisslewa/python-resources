...
def set_players_info():
  player1_info[0] = input('Please enter player1 name: ')
  while True:
...
while playing:
  init()
  set_players_info()
  player_turn = starting_player_turn()
  ...
  while True:
    ...
    if check_winner():
      if player_turn == 1:
        print(f'Congratualtion Player1 {player1_info[0]} WON')
        break
      else:
  ...
  while True:
    user_input = input('Do you want to play another game enter Y/N? ')
